...
<body style="background-color: aqua;">
	...
	<div
		...
		<tr style="background-color: maroon;">
			...
			<br>
			<button style="margin-left: 130px; border-radius: 10px;width: 500px;background-color: maroon;"><th>
				<p style="padding-right:35px; color: white; font-family: sans-serif; font-size: larger;"><th>
		...
		<a href="${pageContext.request.contextPath}/product/justproduct/${product.getProductId()}/${user.getId()}" style="margin-left: 390px"><button style="width: 190px;height:40px;border-radius: 6px;background-color:yellow; color:wgite; padding-left: 190"> purchase</button></a>
	</div>
